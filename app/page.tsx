...
const dict = {
  ...
  zh: {
    nav: { about: '關於我', research: '研究領域', publications: '發表著作', contact: '聯絡資訊' },
    hero: {
      role: '副校長 / 講座教授',
      title1: '先進材料',
      title2: '與',
...
END:VCARD`;
  ...
  return (
    <main className="min-h-screen bg-[#080C16] text-slate-300 font-sans overflow-x-hidden">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 w-full z-50 bg-[#080C16]/70 backdrop-blur-xl border-b border-white/[0.05]">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="font-display text-xl font-bold tracking-widest text-white flex items-center gap-2">
          ...
          <div className="flex items-center gap-8">
            <div className="hidden md:flex space-x-8 text-xs uppercase tracking-[0.2em] font-display text-slate-400">
              ...
              <a href="#research" className="hover:text-amber-400 transition-colors">{t.nav.research}</a>
              <a href="#publications" className="hover:text-amber-400 transition-colors">{t.nav.publications}</a>
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[90vh]">
        <motion.div 
        ...
        >
          <div className="inline-block border border-amber-500/20 bg-amber-500/5 text-amber-400/90 px-4 py-1.5 rounded-full text-[10px] font-mono uppercase tracking-[0.2em] mb-8">
            {t.hero.role}
          </div>
          <h1 className="text-5xl md:text-7xl lg:text-8xl leading-[1.1] mb-8 text-white">
            <span className="font-display font-light text-amber-500/90 tracking-wide">{t.hero.title1}</span> <br />
            <span className="font-display font-bold tracking-tight">{t.hero.title2}</span> {t.hero.title3} <br />
            <span className="font-display font-light text-teal-400/80">{t.hero.title4}</span>
          </h1>
          <p className="text-lg text-slate-400 max-w-md leading-relaxed mb-10 font-light">
            {t.hero.desc}
          </p>
          <div className="flex space-x-4">
            <a href="#publications" className="bg-amber-400 text-[#080C16] px-8 py-4 rounded-full text-xs font-display font-bold uppercase tracking-[0.2em] hover:bg-amber-300 transition-all shadow-[0_0_20px_rgba(251,191,36,0.15)] hover:shadow-[0_0_30px_rgba(251,191,36,0.3)]">
              {t.hero.cta}
            </a>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10">
          {t.research.items.map((item, i) => (
            <motion.div 
              ...
              className="bg-[#0B101E]/80 backdrop-blur-xl border border-white/[0.05] p-10 rounded-2xl hover:border-amber-500/30 hover:bg-[#0F1629] transition-all duration-500 group relative overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.2)]"
            >
              ...
              <div className="relative z-10">
                <div className="w-14 h-14 bg-white/[0.02] rounded-xl flex items-center justify-center mb-8 group-hover:bg-amber-500/10 group-hover:text-amber-400 transition-colors duration-500 border border-white/[0.05] group-hover:border-amber-500/20">
                  <item.icon className="w-6 h-6 stroke-1" />
                </div>
                <h3 className="font-display text-2xl font-medium text-white mb-4">{item.title}</h3>
            ...
            {visiblePublications.map((pub, i) => {
              ...
              return (
                <motion.div 
                  ...
                  className="flex flex-col lg:flex-row gap-8 p-6 md:p-8 bg-[#0B101E]/80 backdrop-blur-xl border border-white/[0.05] rounded-3xl hover:border-amber-500/30 transition-all duration-500 group shadow-[0_8px_32px_rgba(0,0,0,0.2)]"
                >
                  {/* Visuals Column */}
